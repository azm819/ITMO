...
std::map<std::string, std::vector<int>> ModusPonisv, ModusPonisn, ModusPonisc, ModusPonisd, ModusPonisi;
std::set<int> Answer;
...
//                    case 'v': {
//                        auto it = ModusPonisv.find(result->getName());
//                        if (it == ModusPonisv.end()) {
//                            std::cout << "Proof is incorrect";
//                            return 0;
//                        } else {
...
//                                    if (death > (depth[i] + depth[j] + 1) && equal(doc[j], left)) {
//                                        ind = {i, j};
//                                        death = depth[i] + depth[j] + 1;
//                                        if (death == 3) break;
//                                    }
//                                }
//                                if (death == 3) break;
...
//                    }
//                    case 'i': {
//                        auto it = ModusPonisi.find(result->getName());
//                        if (it == ModusPonisi.end()) {
//                            std::cout << "Proof is incorrect";
//                            return 0;
//                        } else {
//                            for (auto &i: it->second) {
...
//                    }
//                    case 'd': {
//                        auto it = ModusPonisd.find(result->getName());
//                        if (it == ModusPonisd.end()) {
//                            std::cout << "Proof is incorrect";
//                            return 0;
//                        } else {
//                            for (auto &i: it->second) {
...
//                    }
//                    case 'c': {
//                        auto it = ModusPonisc.find(result->getName());
//                        if (it == ModusPonisc.end()) {
//                            std::cout << "Proof is incorrect";
//                            return 0;
//                        } else {
//                            for (auto &i: it->second) {
...
//                    }
//                    case 'n': {
//                        auto it = ModusPonisn.find(result->getName());
//                        if (it == ModusPonisn.end()) {
//                            std::cout << "Proof is incorrect";
//                            return 0;
//                        } else {
//                            for (auto &i: it->second) {
...
//            return 0;
//        }
//        if (death != INF) depth.push_back(death);
//        else depth.push_back(1);
//        doc.push_back(result);
//        axioms.push_back(ind);
//        ++sizik;
//        if (checkSize && equal(base, result)) {
//            solve(sizik - 1);
//            checkSize = false;
//            continue;
//        }
//        if (result->getType() == 'i') {
//            switch (result->getRight()->getType()) {
//                case 'v': {
//                    auto key = ModusPonisv.find(result->getRight()->getName());
//                    if (key == ModusPonisv.end()) {
//                        ModusPonisv[result->getRight()->getName()] = {sizik - 1};
//                    } else {
...
//                }
//                case 'n': {
//                    auto key = ModusPonisn.find(result->getRight()->getName());
//                    if (key == ModusPonisn.end()) {
//                        ModusPonisn[result->getRight()->getName()] = {sizik - 1};
//                    } else {
//                        key->second.push_back(sizik - 1);
//                    }
//                    break;
//                }
//                case 'i': {
//                    auto key = ModusPonisi.find(result->getRight()->getName());
//                    if (key == ModusPonisi.end()) {
//                        ModusPonisi[result->getRight()->getName()] = {sizik - 1};
//                    } else {
//                        key->second.push_back(sizik - 1);
//                    }
//                    break;
//                }
//                case 'c': {
//                    auto key = ModusPonisc.find(result->getRight()->getName());
//                    if (key == ModusPonisc.end()) {
//                        ModusPonisc[result->getRight()->getName()] = {sizik - 1};
//                    } else {
//                        key->second.push_back(sizik - 1);
//                    }
//                    break;
//                }
//                case 'd': {
//                    auto key = ModusPonisd.find(result->getRight()->getName());
//                    if (key == ModusPonisd.end()) {
//                        ModusPonisd[result->getRight()->getName()] = {sizik - 1};
//                    } else {
//                        key->second.push_back(sizik - 1);
//                    }
//                    break;
...
//        }
//    }
//    if (Answer.empty() || !equal(result, base)) {
//        std::cout << "Proof is incorrect";
//        return 0;
//    }
//    int cnt = 1;
